  ...
  return (
    <svg width={size.width} height={size.height} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_85_513)">
        ...
        />
        <path d="M8 5.33334V8.00001" stroke="#14142B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M8 10.6667H8.00667" stroke="#14142B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      </g>
      <defs>
