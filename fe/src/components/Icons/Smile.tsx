  ...
  return (
    <svg width={size.width} height={size.height} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        stroke-linejoin="round"
      />
      <path d="M6 6H6.00667" stroke="#14142B" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M10 6H10.0067" stroke="#14142B" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  );
}
