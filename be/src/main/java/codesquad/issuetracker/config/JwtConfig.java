...
public class JwtConfig {
    ...
    private static final long ACCESS_TOKEN_DURATION = 1 * MINUTE; // access token 유효시간 : 1분
    private static final long REFRESH_TOKEN_DURATION = 2 * MINUTE; // refresh token 유효시간 : 2분
