...
public enum ErrorMessage {
	...
	LABEL_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 유저를 찾을 수 없습니다."),
	MILESTONE_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 유저를 찾을 수 없습니다."),
	...
	ISSUE_NOT_FOUND(HttpStatus.NOT_FOUND, "이슈 정보를 찾을 수 없습니다."),
	//500
	...
	MILESTONE_NOT_SAVE(HttpStatus.NOT_IMPLEMENTED, "라벨을 저장할 수 없습니다.");
